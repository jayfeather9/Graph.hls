...
using ap_fixed_pod_t = ap_uint<DISTANCE_BITWIDTH>;
using distance_t = ap_ufixed<DISTANCE_BITWIDTH, DISTANCE_INTEGER_PART>;
...
// Derived constants
const ap_fixed_pod_t INFINITY_POD = 4294967295u;
const ap_fixed_pod_t NEG_INFINITY_POD = 0u;
