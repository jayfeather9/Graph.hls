...
#define MAX_DST_BIG 512
#else
#define MAX_DST_BIG 524288
#endif
#define MAX_NUM MAX_DST_BIG
...
#define INVALID_LOCAL_ID_BIG (local_id_t(1) << LOCAL_ID_MSB)
...
#define EDGE_PAYLOAD_BITS 96
#define EDGES_PER_WORD 5
