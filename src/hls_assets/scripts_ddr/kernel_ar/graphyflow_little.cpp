...
#pragma HLS dependence variable = src_prop_buffer inter false
    ...
    // PR: edge weights are not used (contribution propagation)
...
#pragma HLS UNROLL
                ...
                // PR: sum-reduction (accumulate contributions)
...
#pragma HLS PIPELINE II = 1
        ...
        // PR: sum-reduction
        first_low = (first_low + second_low);
        first_high = (first_high + second_high);
