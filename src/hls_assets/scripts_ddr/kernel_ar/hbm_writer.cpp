...
#pragma HLS STREAM variable = little_prop_loader_out_6 depth = 16
    ...
    big_node_prop_loader(0, src_prop_7, num_partitions_big,cacheline_req_stream_1, cacheline_resp_stream_1);
    big_node_prop_loader(1, src_prop_8, num_partitions_big,cacheline_req_stream_2, cacheline_resp_stream_2);
    big_node_prop_loader(2, src_prop_9, num_partitions_big,cacheline_req_stream_3, cacheline_resp_stream_3);
