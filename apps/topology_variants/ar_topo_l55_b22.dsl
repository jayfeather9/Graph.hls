...
HlsConfig {
    topology: {
        ...
        little_groups: [
            { pipelines: 5 merger_slr: 0 pipeline_slr: [0,0,0,1,1] },
            { pipelines: 5 merger_slr: 1 pipeline_slr: [1,1,2,2,2] }
        ]
        big_groups: [
            { pipelines: 2 merger_slr: 0 pipeline_slr: [0,2] },
            { pipelines: 2 merger_slr: 2 pipeline_slr: [1,2] }
        ]
    }
}
